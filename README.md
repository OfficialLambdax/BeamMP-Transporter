...
Usage:
  ...
  Make sure to add the Transporter UI app to your game, it should start at maximum size. This adds flag & goal markers and message boxes for when you get the flag. 
